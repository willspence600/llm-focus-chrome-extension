what_prompt = """Here’s a refined version of the system prompt with **examples included**, ensuring leniency when determining relevance. The added examples also focus on edge cases to make the model more robust and user-friendly:
